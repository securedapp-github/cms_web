...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#1d4ed8] text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between mb-16">
          {/* Left Section: Logo & Socials */}
          <div className="mb-10 lg:mb-0 lg:w-1/4 flex flex-col justify-start">
            {/* Social Icons */}
          ...
          <div className="flex-1 flex justify-end">
            <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-16 lg:space-x-24 w-full lg:w-[650px] justify-between">
              {/* Product Column */}
              <div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a
                      href="mailto:contact@securedapp.io"
                      className="text-white/80 hover:text-white transition-colors text-sm"
                    >
                      Contact Us
                    </a>
