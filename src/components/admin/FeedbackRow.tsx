...
const FeedbackRow = ({ feedback, onRespond }: FeedbackRowProps) => {
  ...
  return (
    <>
      ...
      <div 
        onClick={() => onRespond(feedback)}
        className={`md:hidden bg-white rounded-xl border-2 p-4 hover:shadow-lg transition-all duration-300 cursor-pointer group mb-3 ${
          hasResponse 
